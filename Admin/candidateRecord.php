...
<h1 style="text-align:center; color:#fff;">Candidate Records</h1>
...
<script>
	...
	setInterval(function(){
		...
		$('#candidateRetrieve').load('candidateRetrieve.php');
...
<?php
		...
		if(empty($_GET["get_RecordCandidate"])){

?>


<div id="candidateRetrieve">

<?php	include("candidateRetrieve.php"); ?>
...
<?php
		...
		include("getCandidateRecord.php");
